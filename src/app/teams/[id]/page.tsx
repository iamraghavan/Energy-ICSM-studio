...
import { User, Trophy as SportIcon } from "lucide-react";
        ...
        <div className="container py-8">
            <Card>
                <CardHeader className="flex flex-col items-center text-center">
                    <div className="w-24 h-24 bg-secondary rounded-full flex items-center justify-center font-bold text-4xl mb-4 border">{team.name.charAt(0)}</div>
                    <CardTitle className="font-headline text-4xl">{team.name}</CardTitle>
                    <CardDescription className="text-lg">{team.college}</CardDescription>
                    {sport && (
                            ...
                            <Card className="bg-muted/50">
                                <CardContent className="pt-6 space-y-4">
                                    <div className="flex items-center gap-3">
                                        <SportIcon className="w-5 h-5 text-muted-foreground" />
                                        <div>
