    ...
    if (error || !registration) {
        return (
            <div className="container py-8 text-center">
                ...
                <Button onClick={() => router.push('/console/admin/registrations')} variant="outline" className="mt-4">Go Back</Button>
            </div>
        );
    }
    ...
    return (
        <div className="container py-8 space-y-6">
            <div className="flex items-center gap-4">
                <Button variant="outline" size="icon" onClick={() => router.push('/console/admin/registrations')}>
