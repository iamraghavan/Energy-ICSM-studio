...
export function EditMemberDialog({ isOpen, onClose, member, sport, onSuccess }: EditMemberDialogProps) {
    ...
    const onSubmit = async (values: FormValues) => {
        try {
            ...
            toast({ title: 'Player Updated', description: `${member.name}'s details have been updated.` });
            onSuccess();
            onClose();
        } catch (error: any) {
            toast({
