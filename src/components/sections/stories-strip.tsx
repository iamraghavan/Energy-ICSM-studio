  ...
  return (
    <section className="bg-background py-6 border-b overflow-hidden">
      <div className="container px-4 sm:px-8">
        <div className="flex items-center gap-4 md:gap-8 overflow-x-auto pb-4 scrollbar-hide snap-x snap-mandatory justify-start md:justify-center">
          {STORIES.map((story, index) => (
            <motion.div
              ...
              className="flex flex-col items-center gap-2 shrink-0 group snap-center"
            >
              <Link href={`/energy/2026/stories/${story.id}`} className="relative">
                ...
                <Avatar className="h-16 w-16 md:h-20 md:w-20 border-2 border-background relative z-10">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground group-hover:text-primary transition-colors truncate max-w-[80px] md:max-w-[100px]">
                {story.title.split(' ')[0]}
              </span>
            </motion.div>
          ))}
          ...
          <Link 
            ...
            className="flex flex-col items-center gap-2 shrink-0 group snap-center"
          >
            <div className="h-16 w-16 md:h-20 md:w-20 rounded-full border-2 border-dashed border-muted-foreground/30 flex items-center justify-center hover:border-primary transition-colors">
